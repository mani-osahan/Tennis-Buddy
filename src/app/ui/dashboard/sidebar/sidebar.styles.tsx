...
export const SidebarWrapper = tv({
    base: "bg-emerald-700 transition-transform h-full fixed -translate-x-full w-64 shrink-0 z-[202] overflow-y-auto border-r border-divider flex-col py-6 px-3 md:ml-0 md:flex md:static md:h-screen md:translate-x-0 ",
...
export const Header = tv({
    base: "flex items-center px-1 h-12 mb-12",
  });
